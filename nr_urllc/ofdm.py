...
def modulate(symbols: np.ndarray, n_subcarriers: int, cp_len: int, dtype=np.complex64) -> np.ndarray:
...
def demodulate(signal: np.ndarray, n_subcarriers: int, cp_len: int, dtype=np.complex64) -> np.ndarray:
